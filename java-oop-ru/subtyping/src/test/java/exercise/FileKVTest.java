...
class FileKVTest {
    ...
    @Test
    void operationTest() {
        KeyValueStorage storage = new FileKV(filepath.toAbsolutePath().toString(), Map.of("key", "10"));
    ...
    void mustBeImmutableTest() {
        ...
        KeyValueStorage storage = new FileKV(filepath.toAbsolutePath().toString(), initial);
