...
class AppTest {
    ...
    void testReversedSequence5() {
        ...
        assertThat(text.chars()).isNotEmpty().hasSize(3);
        assertThat(text.chars()).containsOnly(99, 98, 97);
    }

    @Test
    void testReversedSequence6() {
        CharSequence text = new ReversedSequence("abc");
        assertThat(text.chars()).isNotEmpty().hasSize(3);
        assertThat(text.codePoints()).containsOnly(99, 98, 97);
    }
    // END
}
