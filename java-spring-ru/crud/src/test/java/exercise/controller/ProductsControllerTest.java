...
class ProductsControllerTest {
    ...
    @Test
    public void testPartialUpdateLink() throws Exception {
        productRepository.save(testProduct);
    ...
    @Test
    public void testPartialUpdateAttribute() throws Exception {
        productRepository.save(testProduct);
        ...
        assertThat(task.getTitle()).isEqualTo(dto.getTitle());
        assertThat(task.getPrice()).isEqualTo(dto.getPrice());
        assertThat(task.getCategory().getId()).isEqualTo(testProduct.getCategory().getId());
    }
